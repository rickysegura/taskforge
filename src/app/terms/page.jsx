    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-100 via-blue-200 to-purple-200 text-gray-800 flex flex-col">
      ...
      <main className="flex-grow p-10 mx-6">
        <div className="max-w-4xl mx-auto bg-white bg-opacity-80 p-8 rounded-2xl shadow-xl">
          ...
          <p className="text-gray-600 mb-4">Welcome to TaskForge ("we", "us", or "our"). By using TaskForge, a free task management service, you agree to these Terms of Service ("Terms"). If you don’t agree, please don’t use the service.</p>
          ...
          <p className="text-gray-600 mb-4">TaskForge is provided "as is" with no warranties, express or implied, including fitness for a particular purpose or uninterrupted service.</p>

          <h2 className="text-2xl font-semibold mt-6 mb-4 text-gray-800">5. Limitation of Liability</h2>
          <p className="text-gray-600 mb-4">We’re not liable for damages from your use of TaskForge, including data loss or service interruptions, to the extent permitted by law.</p>

          <h2 className="text-2xl font-semibold mt-6 mb-4 text-gray-800">6. Changes to Terms</h2>
          <p className="text-gray-600 mb-4">We may update these Terms. Check back here for changes. Continued use means acceptance.</p>
