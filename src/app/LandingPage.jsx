...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-100 via-blue-200 to-purple-200 text-gray-800">
      {/* Header */}
      <header className="flex justify-between items-center p-6 mx-6 rounded-2xl shadow-xl backdrop-blur-md bg-white bg-opacity-80">
        ...
        <div className="flex gap-4 items-center">
          <Link
            href="/auth"
            className="px-6 py-2 rounded-full text-lg font-medium transition-all duration-300 hover:scale-105 bg-teal-600 text-white hover:bg-teal-700"
          >
            Sign In
          </Link>
        </div>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between p-10 mx-6 mt-6">
        <div className="max-w-md">
          ...
          <Link
            href="/auth"
            className="inline-block px-8 py-4 rounded-full text-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg bg-teal-600 text-white hover:bg-teal-700"
          >
            Start Now
          </Link>
        </div>
        <div className="mt-10 md:mt-0 md:ml-10 transform hover:scale-105 transition-transform duration-300">
      ...
      {/* Features Section */}
      <section className="p-10 mx-6 rounded-2xl shadow-xl backdrop-blur-md bg-white bg-opacity-80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="p-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-md bg-teal-50 bg-opacity-70 text-gray-800"
            >
      ...
      {/* CTA Section */}
      <section id="get-started" className="p-10 mx-6 text-center">
      ...
      {/* Footer */}
      <footer className="p-6 mx-6 rounded-2xl shadow-xl backdrop-blur-md bg-gray-800 bg-opacity-80 text-white text-center">
